/*
 ...
 Source Schema         : db_lvyou

 Target Server Type    : MySQL
 Target Server Version : 50716
 File Encoding         : 65001

 Date: 29/04/2024 17:07:10
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '地方美食' ROW_FORMAT = Dynamic;
...
CREATE TABLE `diqu`  (
  ...
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '地区' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '景点信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `liuyanban`  (
  ...
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '留言板' ROW_FORMAT = Dynamic;
...
CREATE TABLE `lvyouxianlu`  (
  ...
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '旅游线路' ROW_FORMAT = Dynamic;
...
CREATE TABLE `meishifenlei`  (
  ...
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '美食分类' ROW_FORMAT = Dynamic;
...
CREATE TABLE `shoucangjilu`  (
  ...
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收藏记录' ROW_FORMAT = Dynamic;
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES ('4FG5FZ29G1ZIDQXND3MGI8YEUAIC6I2X', '{\"touxiang\":\"upload/20210423/f0617774-faba-4377-8efa-8946d00ad807.png\",\"mima\":\"111\",\"xingbie\":\"男\",\"login\":\"用户\",\"xingming\":\"大大\",\"yonghuming\":\"111\",\"shouji\":\"13245678910\",\"cx\":\"用户\",\"addtime\":\"2021-04-23 17:52:05\",\"id\":1,\"shenfenzheng\":\"123456789123456\",\"youxiang\":\"15641@qq.com\",\"username\":\"111\"}', '用户', '用户', '111', '1', '2024-03-15 21:33:52');
INSERT INTO `token` VALUES ('93G98HCWIU8T45FPG6CQWHONQIO1XRDT', '{\"cx\":\"管理员\",\"addtime\":\"2021-04-23 16:53:57\",\"id\":1,\"pwd\":\"123456\",\"login\":\"管理员\",\"username\":\"java1234\"}', '管理员', '管理员', 'java1234', '1', '2024-03-15 21:34:41');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '新闻信息' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '预定' ROW_FORMAT = Dynamic;
